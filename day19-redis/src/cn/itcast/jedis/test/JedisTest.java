...
public class JedisTest {
    ...
    public void test2(){
        ...
        jedis.setex("activecode", 20,"hehe");   //将activecode:hehe存入redis，并且20后自动删除该键值对
    ...
    public void test4(){
        ...
        //2. 操作
        //list存储
        jedis.lpush("mylist", "a","b","c"); //从左边存储
        jedis.rpush("mylist", "a","b","c"); //从右边存储
    ...
    public void test7(){
        ...
        config.setMaxTotal(50);    //设置最大允许连接数
